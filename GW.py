...
guidelines_message = (
    "★ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴘʜɪʟᴀɴᴛʜʀᴏᴘʏ  ᴘʟᴇᴀꜱᴇ ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛᴏ ꜰᴏʟʟᴏᴡ ᴛʜᴇꜱᴇ ɢᴜɪᴅᴇʟɪɴᴇꜱ ★ \n"
    "1. ʙᴇ ʀᴇꜱᴘᴇᴄᴛꜰᴜʟ ᴛᴏ ᴏᴜʀ ᴜɴɪᴛ☮ \n"
...
async def bot_info(ctx):
    info_embed = discord.Embed(title='🅶🆆 ⚛', description='ᴀ 🅶🆆 ᴀɪ ʙᴜɪʟᴛ ꜰᴏʀ ᴍᴏᴅᴇʀᴀᴛɪᴏɴ ᴀɴᴅ ᴍᴏʀᴇ ᴀɴᴀʟʏꜱɪꜱ, ᴠᴇʀ 3.0.', color=discord.Color.blue())
...
async def cmd(message):
    helpC = discord.Embed(title="🅶🆆 \n ʜᴇʟᴘ ɢᴜɪᴅᴇ❕", description="☢️ ʙᴜɪʟᴛ ꜰᴏʀ ᴍᴏᴅᴇʀᴀᴛɪᴏɴ ☮︎")
